...
public class DetallePedido implements Serializable {
		...
		public DetallePedido(long id, long pedidos, long productos, float precioUnidades, int unidades, float impuesto,
				double total) {
			super();
			this.id = id;
		...
		public String toString() {
			return "Pedidos [id=" + id + ", pedidos=" + pedidos + ", productos=" + productos + ", precioUnidades="
					+ precioUnidades + ", unidades=" + unidades + ", impuesto=" + impuesto + ", total=" + total + "]";
		}
